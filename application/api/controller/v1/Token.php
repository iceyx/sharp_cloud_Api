...
class Token
{
	 ...
	 * 请求时间差
	 */
	public static $timeDif = 100000000;
	 ...
	 */
	public static $appid = 'RY88f650d48164a1f1';
	/**
	 * appsercet
	 */
	public static $appsercet = 'RUIYun780cfc46d9f2d411';
 ...
 //                    $userAdd['uid'] = $userInfo['uid'];
	...
	{	
		...
		//sign = md5(appsercet+appid+随机数+时间戳)等算法生成一个sign。sign会在调用传输
		//签名检测
